...
namespace ToDo.Microservices.Categories.Tests.Units
{
    public class CategoryRepositoryTests
    {
        ...
        [Fact]
        public async void CategoryRepository_Delete_UserExistAndCategoryCollectionIsNotEmptyAndPublisherIsEnabled_ShouldReturnSuccessTrue()
        {
            //Arrage
        ...
        [Fact]
        public async void CategoryRepository_Delete_UserExistAndCategoryCollectionIsEmptyAndPublisherIsEnabled_ShouldReturnSuccessFalse()
        {
            //Arrage
        ...
        [Fact]
        public async void CategoryRepository_Delete_UserNotExistAndCategoryCollectionIsEmptyAndPublisherIsEnabled_ShouldReturnSuccessFalse()
        {
            //Arrage
        ...
        [Fact]
        public async void CategoryRepository_Delete_UserExistAndCategoryCollectionIsNotEmptyAndPublisherIsDisabled_ShouldReturnSuccessFalse()
        {
            //Arrage
